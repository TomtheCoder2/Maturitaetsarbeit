...
%    \mewpage
    ...
    \begin{enumerate}
        \item My parents, Bettina Jenny und Dirk Wilhelm
        \begin{itemize}
            \vspace{-0.2cm}
            \item Email: \href{mailto:wilk@zhaw.ch}{wilk@zhaw.ch} (Father) \& (private) (Mother)
            \item Contribution: Financial support, technical advice, and encouragement throughout this journey.
            \vspace{-0.2cm}
        \end{itemize}
        \item Ilena Teng and her father Robert Teng
        \begin{itemize}
            \vspace{-0.2cm}
            \item Email: (private)
            \item Contribution: Technical assistance with soldering and sensor integration.
            \vspace{-0.2cm}
        \end{itemize}
        \item FabLab Zürich
        \begin{itemize}
            \vspace{-0.2cm}
            \item Email: \href{mailto:vorstand@zurich.fablab.ch}{vorstand@zurich.fablab.ch}
            \item Contribution: Providing access to laser cutting, 3D printing, and CNC machining, and helpful guidance by the team members.
            \vspace{-0.2cm}
        \end{itemize}
        \item Gabriel Schneider from ZHAW
        \begin{itemize}
            \vspace{-0.2cm}
            \item Email: \href{mailto:gabriel.schneider@zhaw.ch}{gabriel.schneider@zhaw.ch}
            \item Contribution: Expertise and support in the design process.
            \vspace{-0.2cm}
        \end{itemize}
        \item Clemens Pohle, my supervisor
        \begin{itemize}
            \vspace{-0.2cm}
            \item Email: \href{mailto:clemens.pohle@kshp.ch}{clemens.pohle@kshp.ch}
            \item Contribution: Continuous supervision and insightful feedback, which greatly improved the quality of this documentation.
            \vspace{-0.2cm}
        \end{itemize}
    \end{enumerate}
