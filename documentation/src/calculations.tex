...
\end{center}
%    \\
That means we have the distance $l$ to accelerate the ball together with the player.
\begin{equation}
    \label{eq:distance}
...
We film the table from the bottom to avoid the players and the rods, therefore, we have to replace the floor of the table with a glass plate.
