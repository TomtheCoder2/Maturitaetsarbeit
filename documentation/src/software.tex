...
\todo{swithc location and timing}
\begin{center}
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (pro4) [process, below of=pro3, right of=pro3, xshift=1.5cm] {Timing?};
        \node (pro5) [process, below of=pro3, left of=pro3, xshift=-1.5cm] {Location?};
        ...
        \draw [arrow] (pro4) |- (out1) node[below,midway] {Target player position};
...
%
%dimensions: 728, 544
                \draw [red, thick] (0.0384615385, 0.1636029412) -- (0.0343406593, 0.8805147059) -- (698/728, 495/544) -- (713/728, 101/544) -- cycle;
                \draw [red, thick] (281/728, 219/544) -- (272/728, 375/544) -- (432/728, 386/544) -- (440/728, 228/544) -- cycle;
            \end{scope}
        \end{tikzpicture}
