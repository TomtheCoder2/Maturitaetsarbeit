...
\begin{tikzpicture}[H]
    ...
    \node [anchor=east, text width=3cm] (holder) at (18.5,5) {\Large Holder \small connects the motor to the wall of the table};
    ...
    \node [anchor=east, text width=3cm] (slit) at (18.5,2) {\Large Slit};
    \node [anchor=east, text width=3cm] (pin) at (18.5,3) {\Large Pin};
    \begin{scope}[xshift=1.5cm]
...
%            \draw [-stealth, line width=5pt, cyan] (water) -- ++(0.4,0.0);
            ...
            \draw [-stealth, line width=2pt, red] (holder) -- ++(-0.63, 0.0);
            \draw [-stealth, line width=2pt, red] (main-tube) -- ++(-0.16, 0.0);
            \draw [-stealth, line width=2pt, red] (larger-tube) to[out=180, in=90] ++(-0.5, -0.21);
            \draw [-stealth, line width=2pt, red] (slit) to[out=180, in=-90] ++(-0.4, 0.425);
            \draw [-stealth, line width=2pt, red] (pin) to[out=180, in=-90] ++(-0.45, 0.318);
%            \draw [-latex, ultra thick, red] (tube) to[out=180, in=-25] ++(-0.33,0.25);
        \end{scope}
    \end{scope}
\end{tikzpicture}%
\todo{Maybe switch Holder and slit and pin}
